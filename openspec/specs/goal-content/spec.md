# goal-content Specification

## Purpose
Goal content provides authored campfire-lore entries (stories, poetry, appendix reference material) attached to goals, with type-specific rendering, locked-teaser placeholders, and best-effort discovery analytics. Content reuses existing goal unlock semantics — no separate content-level access control.
