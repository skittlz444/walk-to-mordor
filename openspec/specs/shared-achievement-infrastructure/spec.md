# shared-achievement-infrastructure Specification

## Purpose
The shared achievement infrastructure provides reusable append-only achievement definitions and earnable instances with idempotency guarantees. Consuming features (books, personal challenges, community campaigns) use this service to award badges without duplicating achievement storage, idempotency, or aggregation logic.
