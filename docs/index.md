---
name: index
description: Master index of all project documentation with brief descriptions.
---
...
- [Asset Workflow](asset-workflow.md) — Goal image pipeline, admin image management, and static asset rules.
- [Email](email.md) — Email delivery configuration, template patterns, and testing strategies.

## Archive

Legacy and pre-merge docs are kept in `docs/archive/`.
