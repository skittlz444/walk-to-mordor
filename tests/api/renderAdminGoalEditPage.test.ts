...
describe('renderAdminGoalEditPage', () => {
  let html: string;

  beforeAll(() => {
    html = renderAdminGoalEditPage();
  });
  ...
  describe('HTML structure', () => {
    ...
    it('should have correct page title', () => {
      expect(html).toContain('<title>Walk to Mordor - Edit Goal</title>');
    });
  ...
  describe('main content area', () => {
    it('should have AdminGoalEditIsland mount point', () => {
      expect(html).toContain('data-island="AdminGoalEditIsland"');
    });
    ...
    it('should have correct breadcrumb trail: Admin > Goals > Edit Goal', () => {
      ...
      expect(breadcrumbSection).toContain('Edit Goal');
    });
